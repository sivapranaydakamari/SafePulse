// MOVED FROM: features/safepulse/services/sensor_service.dart
import 'dart:async';
import 'dart:math';
...
class SensorService {
  ...
  void startTracking({
    ...
    _positionSubscription =
      ...
      (Position position) {
        ...
        // Sudden braking detection logic could be added here
      },
    );
  }
  ...
  void _restartAccel() {
    ...
    onLog?.call("⚠️ Accelerometer error. Retrying...");
  ...
  void _restartGyro() {
    ...
    onLog?.call("⚠️ Gyroscope error. Retrying...");
    Future.delayed(delay, () {
      _gyroRetryCount++;
      _startGyro();
    });
